...
public class ViewPagerAdapter extends RecyclerView.Adapter<ViewPagerAdapter.ViewHolder> {
    ...
    public ViewPagerAdapter(Context context, List<String> data,List<String> data1, ViewPager2 viewPager2,String whichpage) {
    ...
    public ViewPagerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       switch (whichpage){
           case "huawei":view = mInflater.inflate(R.layout.huawei_userguide_page, parent, false);
                       break;
           case "oneplus":view = mInflater.inflate(R.layout.oneplus_userguide_page, parent, false);
             break;
