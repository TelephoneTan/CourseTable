...
//                startActivity(new Intent(Login.this, Login_vpn.class));
    ...
    /**
     * @ui 1. clear old input, old image, old cookie
    ...
    /**
     * @non-ui 1. get all user names in the database
    ...
    /**
     * @ui/non-ui 1. build an AlertDialog in this activity:
    ...
    /**
     * @ui 1. disable buttons, check-code-image-view
     * 2. show progress-bar
     * @clear
     */
    private void lock() {
    ...
    /**
     * @ui 1. for each input box, if it is not null:
     * 1. clear IM on it
     * 2. clear focus of it
     * @clear
     */
...
//        }
     ...
     * @non-ui 1. delete all user-related data from database(not including user login information)
     * @clear
     */
    ...
    /**
     * @return - res.code == 0 : login success
     * - res.code != 0 : login fail
     * @non-ui 1. try to login credit system with:
     * - student id : sid
     * - password : pwd
     * - check-code : ckcode
     * - Cookie : cookie
     ...
     * @non-ui 1. call and return {@link Login_vpn#vpn_login(Context, String, String)}
     * @clear
     */
     ...
     * @return - res.code == 0 : login success
     * - res.code != 0 : login fail
     * @non-ui 1. try to login aaw with:
     * - student id : sid
     * - password : pwd
...
//        return login_res;
    ...
    /**
     * @ui 1. if {@link MyApp#getRunning_activity()} is {@link MyApp.RunningActivity#LOGIN}:
    ...
    /**
     * @ui 1. call {@link #clearAllIMAndFocus()}
